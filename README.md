...
## 📸 اسکرین‌شات (نمایش واقعی)
> **برای دیدن اسکرین‌شات واقعی از ابزارت، بعداً این لینک رو عوض می‌کنیم.**
...
## ⚠️ سلب مسئولیت (Legal Disclaimer)

> **این ابزار فقط برای اهداف آموزشی و تست نفوذ روی سیستم‌های خودتان طراحی شده است.**  
> هرگونه استفاده غیرمجاز از این ابزار بر عهده کاربر نهایی بوده و توسعه‌دهنده هیچ مسئولیتی در قبال سوء استفاده از آن ندارد.  
> لطفاً قبل از استفاده، قوانین محلی خود را بررسی کنید.
